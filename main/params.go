...
func init() {
	...
	// DJTX fees:
	fs.Uint64Var(&Config.TxFee, "tx-fee", units.MilliDjtx, "Transaction fee, in nDJTX")
	...
	fs.Uint64Var(&Config.MinStake, "min-stake", 5*units.MilliDjtx, "Minimum stake, in nDJTX, required to validate the primary network")
